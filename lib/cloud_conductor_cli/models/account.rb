  ...
  module Models
    class Account < Thor
      ...
      def create
        ...
        display_message('Create completed successfully.') unless options[:format] == 'json'
        output(response)
      end
      ...
      def update(account)
        ...
        display_message('Update completed successfully.') unless options[:format] == 'json'
        output(response)
      end
      ...
      def delete(account)
        ...
        display_message('Delete completed successfully.') unless options[:format] == 'json'
      end
    end
  end
end
