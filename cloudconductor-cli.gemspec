...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Command line tool for CloudConductor}
  spec.description   = %q{Command line tool for CloudConductor that manage clouds, systems, and applications.}
